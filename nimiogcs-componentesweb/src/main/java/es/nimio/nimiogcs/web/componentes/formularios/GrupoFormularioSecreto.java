 ...
 */
@Fragmento(grupo="_formularios", id="grupo-secreto")
public class GrupoFormularioSecreto implements IComponente {
	...
	public GrupoFormularioSecreto(String field, String placeholder, String etiqueta, String descripcion) {
