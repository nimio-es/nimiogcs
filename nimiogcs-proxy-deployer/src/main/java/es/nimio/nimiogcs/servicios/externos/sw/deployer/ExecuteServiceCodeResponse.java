...
@XmlRootElement(name = "executeServiceCodeResponse")
public class ExecuteServiceCodeResponse {

    @XmlElementRef(name = "return", namespace = "http://ws.pai.nimio.es", type = JAXBElement.class)
